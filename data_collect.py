    ...
    for route_id in tqdm.tqdm(range(10)):
        ...
        for ep_id in range(1):
            ...
            while not c_route:
                ...
                array_path = episode_dir / 'central_rgb' / '{:0>4d}.npy'.format(i_step)
                np.save(array_path, central_rgb)
                ...
                array_path = episode_dir / 'left_rgb' / '{:0>4d}.npy'.format(i_step)
                np.save(array_path, left_rgb)
                ...
                array_path = episode_dir / 'right_rgb' / '{:0>4d}.npy'.format(i_step)
                np.save(array_path, right_rgb)
